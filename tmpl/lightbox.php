...
<div id="contactus-lightbox<?php if (isset($module->id)){echo $module->id;};?>" class="contactus-lightbox contactus-lightbox<?php if (isset($module->id)){echo $module->id;};?>">
	<div class="contactus-lightbox-caption" style="background-color:<?php echo (isset($fields->color) ? $fields->color : "#21ad33");?>;">
		<div class="contactus-lightbox-cap"><h4 class="text-center"><?php if (!empty($fields->title_name)){echo $fields->title_name;}else {echo JText::_('MOD_CONTACTUS_TITLE_NAME_MODULE');};?></h4></div><div class="contactus-lightbox-closer"><i id="contactus-lightbox-close<?php if (isset($module->id)){echo $module->id;};?>" class="fa fa-close fa-1x"></i></div>		
	</div>
	<div class="contactus-lightbox-body">
		<form  action="<?php echo JFactory::getURI();?>" method="post" class="reg_form" id="contactusForm" onsubmit="contactus_validate(this);joomly_analytics(<?php echo $module->id;?>);" enctype="multipart/form-data">
		<div>
