...
class JFormFieldFields extends JFormField{
    ...
    protected function  getInput() {
		...
		$html.= '<input type="hidden" id="radio" value="' . JText::_('MOD_CONTACTUS_RADIO') . '">';
		...
		{	
			...
			{	
				...
				<option '. ($f->type == 'Radio' ? "selected": "") . ' value="Radio">' . JText::_('MOD_CONTACTUS_RADIO') . '</option>
...
<script type="text/javascript">
	...
	window.onload = function()
	{
		...
		text_radio = document.getElementById("radio").value,
	...
	function Select_element(element)
	{
		...
		if (element.value == "Select" || element.value == "Radio")
		{	
